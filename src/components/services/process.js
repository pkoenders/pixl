            ...
            <div className={ourProcessStyles.ourProcessWrapper}>
                ...
                <ul>
                    <li>
                        ...
                        <p>Good design includes a design process that aligns with an overarching strategy. The following process has been created for website design and can be adpated for graphic design.</p>
                        ...
                        <ol>
                            <li>
                                ...
                                <p>We work with you to determine what are the goals that need to fulfill. I.e., what is the purpose of the project?</p>
                            </li>
                            <li>
                                <h4>Discovery, scope &amp; definition</h4>
                                <p>Knowing ehat the goals are, we can define the scope of the project. I.e., what elements and features are required to fulfill the goal, and the timeline for building those out.</p>
                            </li>
                            <li>
                                <h4>Sitemap &amp; wireframe creation</h4>
